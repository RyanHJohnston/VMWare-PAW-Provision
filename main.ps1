...
.EXAMPLE
    .\New-PawVM.ps1 -VMName 'MyNewVM' -User abc123
#>
...
Process {
    ...
    <#.NOTES
        - The below Sleep command is to help prevent situations where the post customization reboot is delayed slightly causing the Wait-Tools command to think everything is fine and carrying on with the script before all services are ready
    #>
    Start-Sleep -Seconds 30
    ...
    <#.NOTES
        - This is where the win11 installation process fails after the vm is created and powered on 
    #>
    # ...

    <#.NOTES
        - Another short sleep here to make sure that other services have time to come up after VMWare Tools are ready.
    #>
    Start-Sleep -Seconds 30
